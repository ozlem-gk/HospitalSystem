<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Defaultt.aspx.cs" Inherits="HospitalSystem.Defaultt" %>
...
<html lang="tr">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Hastane Kayıt Sistemi</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li>
                            <asp:Button ID="login_page" CssClass="dropdown-item" runat="server" Text="Giriş" /></li>
                        <li>
